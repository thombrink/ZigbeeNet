...
namespace ZigBeeNet.ZCL.Clusters
{
    public class ZclBasicCluster : ZclCluster
    {
         ...
         */
        public const int CLUSTER_ID = 0x0000;
         ...
         */
        public const int ATTR_ZCLVERSION = 0x0000;
        /**
         ...
         */
        public const int ATTR_APPLICATIONVERSION = 0x0001;
        /**
         ...
         */
        public const int ATTR_STACKVERSION = 0x0002;
        /**
         ...
         */
        public const int ATTR_HWVERSION = 0x0003;
        /**
         ...
         */
        public const int ATTR_MANUFACTURERNAME = 0x0004;
        /**
         ...
         */
        public const int ATTR_MODELIDENTIFIER = 0x0005;
        /**
         ...
         */
        public const int ATTR_DATECODE = 0x0006;
        /**
         ...
         */
        public const int ATTR_POWERSOURCE = 0x0007;
        /**
         ...
         */
        public const int ATTR_LOCATIONDESCRIPTION = 0x0010;
        /**
         ...
         */
        public ZclBasicCluster(ZigBeeEndpoint zigbeeEndpoint, ZigBeeNetworkManager networkManager) : base(zigbeeEndpoint, networkManager, CLUSTER_ID, CLUSTER_NAME)
        { 
        }
         ...
         * the ZigBee Cluster Library that all clusters on this endpoint conform to.
         * <p>
         * The attribute is of type {@link ushort}.
         * <p>
         ...
         * @return the {@link ushort} attribute value, or null on error
         */
        public ushort GetZclVersion(long refreshPeriod)
        {
            if (_attributes[ATTR_ZCLVERSION].IsLastValueCurrent(refreshPeriod))
            {
                return (ushort)_attributes[ATTR_ZCLVERSION].LastValue;
            }

            return (ushort)ReadSync(_attributes[ATTR_ZCLVERSION]);
        }
         ...
         * @return the {@link ushort} attribute value, or null on error
         */
        public ushort GetApplicationVersion(long refreshPeriod)
        {
            if (_attributes[ATTR_APPLICATIONVERSION].IsLastValueCurrent(refreshPeriod))
            {
                return (ushort)_attributes[ATTR_APPLICATIONVERSION].LastValue;
            }

            return (ushort)ReadSync(_attributes[ATTR_APPLICATIONVERSION]);
        }
         ...
         * @return the {@link ushort} attribute value, or null on error
         */
        public ushort GetHwVersion(long refreshPeriod)
        {
            if (_attributes[ATTR_HWVERSION].IsLastValueCurrent(refreshPeriod))
            {
                return (ushort)_attributes[ATTR_HWVERSION].LastValue;
            }

            return (ushort)ReadSync(_attributes[ATTR_HWVERSION]);
        }
         ...
         * @return the {@link ushort} attribute value, or null on error
         */
        public ushort GetPowerSource(long refreshPeriod)
        {
            if (_attributes[ATTR_POWERSOURCE].IsLastValueCurrent(refreshPeriod))
            {
                return (ushort)_attributes[ATTR_POWERSOURCE].LastValue;
            }

            return (ushort)ReadSync(_attributes[ATTR_POWERSOURCE]);
        }
         ...
         * The implementation of this attribute by a device is MANDATORY
         *
         * @param physicalEnvironment the {@link ushort} attribute value to be Set
         * @return the {@link Task<CommandResult>} command result future
         */
         ...
         * @return the {@link ushort} attribute value, or null on error
         */
        public ushort GetPhysicalEnvironment(long refreshPeriod)
        {
            if (_attributes[ATTR_PHYSICALENVIRONMENT].IsLastValueCurrent(refreshPeriod))
            {
                return (ushort)_attributes[ATTR_PHYSICALENVIRONMENT].LastValue;
            }

            return (ushort)ReadSync(_attributes[ATTR_PHYSICALENVIRONMENT]);
        }
         ...
         */
        public Boolean GetDeviceEnabled(long refreshPeriod)
        {
            if (_attributes[ATTR_DEVICEENABLED].IsLastValueCurrent(refreshPeriod))
            {
                return (Boolean)_attributes[ATTR_DEVICEENABLED].LastValue;
            }

            return (Boolean)ReadSync(_attributes[ATTR_DEVICEENABLED]);
        }
         ...
         * The implementation of this attribute by a device is MANDATORY
         *
         * @param alarmMask the {@link ushort} attribute value to be Set
         * @return the {@link Task<CommandResult>} command result future
         */
         ...
         * @return the {@link ushort} attribute value, or null on error
         */
        public ushort GetAlarmMask(long refreshPeriod)
        {
            if (_attributes[ATTR_ALARMMASK].IsLastValueCurrent(refreshPeriod))
            {
                return (ushort)_attributes[ATTR_ALARMMASK].LastValue;
            }

            return (ushort)ReadSync(_attributes[ATTR_ALARMMASK]);
        }
         ...
         * The implementation of this attribute by a device is MANDATORY
         *
         * @param disableLocalConfig the {@link ushort} attribute value to be Set
         * @return the {@link Task<CommandResult>} command result future
         */
         ...
         * @return the {@link ushort} attribute value, or null on error
         */
        public ushort GetDisableLocalConfig(long refreshPeriod)
        {
            if (_attributes[ATTR_DISABLELOCALCONFIG].IsLastValueCurrent(refreshPeriod))
            {
                return (ushort)_attributes[ATTR_DISABLELOCALCONFIG].LastValue;
            }

            return (ushort)ReadSync(_attributes[ATTR_DISABLELOCALCONFIG]);
        }
         ...
         * <p>
         * On receipt of this command, the device reSets all the _attributes of all its clusters
